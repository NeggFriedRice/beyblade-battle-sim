...
class Battle:
    ...
    def battle(self, opponent):
        ...
        if self.beyblade.get_total_stats() > opponent.beyblade.get_total_stats():
            ...
            print(f"You get ${win_money} for winning this round!")
            ...
            print(f"{self.beyblade.name} has lost the battle!")
...
class Dialogue:
    ...
    def rules():
        ...
        delay_print(f"This is a 3 round tournament! You will need to win AT LEAST 2 out of the 3 rounds and have {money_target} dollars left in the bank to fly home!\n")
